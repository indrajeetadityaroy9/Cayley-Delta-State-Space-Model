...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    // Intra-chunk scan
    m.def("intra_chunk_scan_fwd_cuda", &kssm::intra_chunk_scan_fwd_cuda,
          "Intra-chunk delta-rule scan forward",
          py::arg("A_flat"), py::arg("K_flat"), py::arg("V_flat"), py::arg("beta_flat"));

    m.def("intra_chunk_scan_bwd_cuda", &kssm::intra_chunk_scan_bwd_cuda,
    ...
    // Adaptive timestep
    m.def("adaptive_dt_fwd_cuda", &kssm::adaptive_dt_fwd_cuda,
    ...
    m.def("adaptive_dt_bwd_cuda", &kssm::adaptive_dt_bwd_cuda,
